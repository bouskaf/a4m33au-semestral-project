...
fof(occupied_only_once, axiom, (![T, Train, OtherTrain, N]: ((at(T, Train, N) & at(T, OtherTrain, N)) => (Train = OtherTrain)))).

% If there is train on switch node output direction has to remain same.
fof(switch_restr, axiom, (![T, N1, N2]: (((switch(succ(T), N1) = N2) & ~empty(T, N1)) => (switch(T, N1) = N2)))).
...
fof(train_enters, axiom, (?[Train, N1]: ![T1, T2, N2]: enter(succ(T2), Train, N1) => (~at(T1, Train, N2) & ~at(T2, Train, N2) & ~enter(T2, Train, N2) & empty(T2, N1) & input(N1) & less(T1, T2)))).
...
fof(switch_in_with_gate_out2, axiom, (![T, Train]: ((at(T, Train, in) & (gate(Train) = out2)) => (switch(T, in) = s1)))).
...
fof(switch_in_with_gate_out3, axiom, (![T, Train]: ((at(T, Train, in) & (gate(Train) = out3)) => (switch(T, in) = s1)))).
...
fof(switch_in_with_gate_out4, axiom, (![T, Train]: ((at(T, Train, in) & (gate(Train) = out4)) => (switch(T, in) = s1)))).
...
fof(switch_in_with_gate_out1, axiom, (![T, Train]: ((at(T, Train, in) & (gate(Train) = out1)) => (switch(T, in) = s1)))).
...
fof(path_free_from_in_to_out2, axiom, (![T, Train, OtherTrain]: (path_free(T, Train, in, out2) <=> (at(T, Train, in) & (gate(Train) = out2) & (~at(T, OtherTrain, in) | (Train = OtherTrain)) & (~at(T, OtherTrain, s1) | (Train = OtherTrain)) & (~at(T, OtherTrain, s2) | (Train = OtherTrain)) & (~at(T, OtherTrain, out2) | (Train = OtherTrain)))))).
fof(path_free_from_in_to_out3, axiom, (![T, Train, OtherTrain]: (path_free(T, Train, in, out3) <=> (at(T, Train, in) & (gate(Train) = out3) & (~at(T, OtherTrain, in) | (Train = OtherTrain)) & (~at(T, OtherTrain, s1) | (Train = OtherTrain)) & (~at(T, OtherTrain, s3) | (Train = OtherTrain)) & (~at(T, OtherTrain, out3) | (Train = OtherTrain)))))).
fof(path_free_from_in_to_out4, axiom, (![T, Train, OtherTrain]: (path_free(T, Train, in, out4) <=> (at(T, Train, in) & (gate(Train) = out4) & (~at(T, OtherTrain, in) | (Train = OtherTrain)) & (~at(T, OtherTrain, s1) | (Train = OtherTrain)) & (~at(T, OtherTrain, s3) | (Train = OtherTrain)) & (~at(T, OtherTrain, out4) | (Train = OtherTrain)))))).
fof(path_free_from_in_to_out1, axiom, (![T, Train, OtherTrain]: (path_free(T, Train, in, out1) <=> (at(T, Train, in) & (gate(Train) = out1) & (~at(T, OtherTrain, in) | (Train = OtherTrain)) & (~at(T, OtherTrain, s1) | (Train = OtherTrain)) & (~at(T, OtherTrain, s2) | (Train = OtherTrain)) & (~at(T, OtherTrain, out1) | (Train = OtherTrain)))))).
